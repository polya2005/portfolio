# SPAIDv1: The Star Pointing and Identification Device (Prototype v1)

## Motivation

I started this project in my sophomore year of high school as a part of my science project sponsored by the Thai government's Development and Promotion of Science and Technology Talents Project (DPST) program. By the time I finished high school, I had built the first prototype, which served as a proof of concept but would benefit from further refining.
